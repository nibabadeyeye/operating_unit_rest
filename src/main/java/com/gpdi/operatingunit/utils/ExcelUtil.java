...
public class ExcelUtil {
     ...
     * @throws
     */
    public <T> List<T> importDataFromExcel(Object vo, InputStream is, String excelFileName) throws Exception {
        ...
        try {
            ...
            System.out.println("获得数据行数"+rows);
            //获取表头单元格个数
                ...
                while (index < cells) {
                    ...
                    switch (cellType){
                        ...
                        case STRING:
                            ...
                            break;
                        case BLANK:
                            System.out.println("当前值为空"+i);
                            break;
                            //throw new Exception("导入的数据为空有某些字段为空");
                        default:
                            break;
                    }
